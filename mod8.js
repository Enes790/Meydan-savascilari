// ========== mod7.js (BUZUL ÇAĞI) - YENİ MİMARİ - PARÇA 1/3 ==========
...
// ========== PARÇA 2 SONU ==========    // ========== PARÇA 3 BAŞLANGICI ==========
    ...
    window.GAME_EXT.chainHook('onDraw', function (ctx2) {
        ...
        buzBotSpawnUyarilari.forEach(u => {
            ctx2.save(); ctx2.translate(u.x, u.y);
            ctx2.globalAlpha = Math.abs(Math.sin(Date.now() / 150));
            ctx2.beginPath(); ctx2.arc(0, 0, BUZ_BOT_RADIUS + 15, 0, Math.PI * 2);
            ctx2.strokeStyle = '#2e86c1'; ctx2.lineWidth = 3; ctx2.stroke();
            ctx2.globalAlpha = 1;
            ctx2.fillStyle = '#2e86c1'; ctx2.font = "bold 16px Arial"; ctx2.textAlign = "center";
        ...
        ciritciSpawnUyarilari.forEach(u => {
            ctx2.save(); ctx2.translate(u.x, u.y);
            ctx2.globalAlpha = Math.abs(Math.sin(Date.now() / 150));
            ctx2.beginPath(); ctx2.arc(0, 0, CIRITCI_RADIUS + 12, 0, Math.PI * 2);
            ctx2.strokeStyle = '#5dade2'; ctx2.lineWidth = 3; ctx2.stroke();
            ctx2.globalAlpha = 1;
            ctx2.fillStyle = '#5dade2'; ctx2.font = "bold 14px Arial"; ctx2.textAlign = "center";
        ...
        heykelTirasiSpawnUyarilari.forEach(u => {
            ctx2.save(); ctx2.translate(u.x, u.y);
            ctx2.globalAlpha = Math.abs(Math.sin(Date.now() / 150));
            ctx2.beginPath(); ctx2.arc(0, 0, HEYKEL_TIRASI_RADIUS + 12, 0, Math.PI * 2);
            ctx2.strokeStyle = '#8e44ad'; ctx2.lineWidth = 3; ctx2.stroke();
            ctx2.globalAlpha = 1;
            ctx2.fillStyle = '#8e44ad'; ctx2.font = "bold 14px Arial"; ctx2.textAlign = "center";
            ctx2.fillText(Math.ceil(u.timer / 60), 0, 5);
            ctx2.restore();
        });
        ...
        bogaSpawnUyarilari.forEach(u => {
            ctx2.save(); ctx2.translate(u.x, u.y);
            ctx2.globalAlpha = Math.abs(Math.sin(Date.now() / 150));
            ctx2.beginPath(); ctx2.arc(0, 0, 28 + 12, 0, Math.PI * 2);
            ctx2.strokeStyle = '#5dade2'; ctx2.lineWidth = 3; ctx2.stroke();
            ctx2.globalAlpha = 1;
            ctx2.fillStyle = '#5dade2'; ctx2.font = "bold 14px Arial"; ctx2.textAlign = "center";
            ctx2.fillText(Math.ceil(u.timer / 60), 0, 5);
        ...
        // Bot çizimleri (kısaltılmış, orijinalinden kopyalanmalı)
        // ... (Buz Botu, Ciritçi, Heykel Tıraşı, Heykel, Buz Boğası, slime'lar)
    });
